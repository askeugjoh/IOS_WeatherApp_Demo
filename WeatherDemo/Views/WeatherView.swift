...
//  WeatherDemo
//
//  Created by Askia Johnson on 5/12/22.
//
    ...
    var body: some View {
        ZStack(alignment: .leading) {
            ...
            VStack {
                ...
                .padding()
                .padding(.bottom, 20)
                .foregroundColor(Color(hue: 0.526, saturation: 0.875, brightness: 0.743))
                .background(.white)
        ...
        .background(Color(hue: 0.526, saturation: 0.875, brightness: 0.743))
